...
namespace BlockchainAssignment
{
    public partial class BlockchainApp : Form
    {
        ...
        private void validateKeysBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                color = Color.Blue;
                validateKeysBtn.BackColor = color;
        ...
        {
            outputRichTxtBox.Text = blockchain.GetBalance(publicKeyTxtBox.Text).ToString() + " Coin";
        }
        ...
        private void miningGroupBox_Enter(object sender, EventArgs e)
        {

        }

        private void walletGroupBox_Enter(object sender, EventArgs e)
        {
